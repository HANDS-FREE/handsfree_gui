...
void TransportSerial::setParam(const TransportParam &param){
  port_->set_option(
              boost::asio::serial_port::baud_rate(param.baud_rate));
  port_->set_option(
              boost::asio::serial_port::flow_control((boost::asio::serial_port::flow_control::type)param.flow_control));
  port_->set_option(
              boost::asio::serial_port::parity((boost::asio::serial_port::parity::type)param.parity_bits));
  port_->set_option(
              boost::asio::serial_port::stop_bits((boost::asio::serial_port::stop_bits::type)param.stop_bits));
  port_->set_option(boost::asio::serial_port::character_size(param.data_bits));
}
...
void TransportSerial::enable(bool enable){
